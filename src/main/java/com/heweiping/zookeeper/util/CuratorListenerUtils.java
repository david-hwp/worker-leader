 ...
 * Created by WeiPing He on 2017/5/27 上午12:59.
...
public class CuratorListenerUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //setListenerDateNode();
//        setListenerThreeOne(client);
//         setListenerThreeTwo(client);
    ...
    public static void setListenerThreeOne(CuratorFramework client, String path) throws Exception {
        ExecutorService pool = Executors.newCachedThreadPool();
...
//        childrenCache.start(StartMode.POST_INITIALIZED_EVENT);
    ...
    private static void setListenerThreeTwo(CuratorFramework client) throws Exception {
        ExecutorService pool = Executors.newCachedThreadPool();
        //设置节点的cache
    ...
    private static void showChildsAndData(CuratorFramework client, String path) throws Exception {
